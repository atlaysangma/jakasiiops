        ...
        try:
            ...
            if len(parts) == 3 and parts[0] == "stores":
                ...
                routes = {
                    ...
                    "schema": lambda: self.brain.schema_catalog(store_id),
                    "awareness": lambda: self.brain.awareness(store_id),
                    "snapshot": lambda: self.brain.operational_snapshot(store_id),
                    "proofs": lambda: self.brain.operation_proofs(store_id),
                    "agent": lambda: self.brain.agent_status(store_id),
